...
public class ListIzinKeluarKantor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((!sharedPrefManager.getSpIdJabatan().equals("41") && !sharedPrefManager.getSpIdJabatan().equals("10") && !sharedPrefManager.getSpIdJabatan().equals("3")) && (!sharedPrefManager.getSpIdJabatan().equals("11") && !sharedPrefManager.getSpIdJabatan().equals("25") && !sharedPrefManager.getSpIdJabatan().equals("4")) && (!sharedPrefManager.getSpNik().equals("1280270910") && !sharedPrefManager.getSpNik().equals("1090080310") && !sharedPrefManager.getSpNik().equals("2840071116") && !sharedPrefManager.getSpNik().equals("1332240111") && !sharedPrefManager.getSpNik().equals("1738040712")) && !sharedPrefManager.getSpIdDept().equals("21")) {
