...
public class DeviceWarningForgotPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_warning_forgot_password);
        loginBTN = findViewById(R.id.to_back_btn);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                new KAlertDialog(DeviceWarningForgotPasswordActivity.this, KAlertDialog.WARNING_TYPE)
    ...
    private void connectionFailed(){
        CookieBar.build(DeviceWarningForgotPasswordActivity.this)
                .setTitle("Perhatian")
