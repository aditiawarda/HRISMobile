...
public class DataPengumuman {
    ...
    public String getPengumuman_title() {
        return pengumuman_title;
    }

    public void setPengumuman_title(String pengumuman_title) {
    ...
    public String getPengumuman_time() {
        return pengumuman_time;
    }

    public void setPengumuman_time(String pengumuman_time) {
