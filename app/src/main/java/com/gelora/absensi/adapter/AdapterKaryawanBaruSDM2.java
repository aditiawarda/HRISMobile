...
public class AdapterKaryawanBaruSDM2 extends RecyclerView.Adapter<AdapterKaryawanBaruSDM2.MyViewHolder> {

    private KaryawanSDM[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterKaryawanBaruSDM2(KaryawanSDM[] data, FormSdmActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.parentPart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("f3_karyawan_baru_broad");
