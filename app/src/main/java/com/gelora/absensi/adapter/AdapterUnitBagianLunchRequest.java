...
public class AdapterUnitBagianLunchRequest extends RecyclerView.Adapter<AdapterUnitBagianLunchRequest.MyViewHolder> {
    ...
    private BagianLunchRequest[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterUnitBagianLunchRequest(BagianLunchRequest[] data, FormLunchRequestActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        final BagianLunchRequest dataBagian = data[i];
        ...
        myViewHolder.statusParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("bagian_broad_rl");
                intent.putExtra("id_bagian",dataBagian.getIdDept());
