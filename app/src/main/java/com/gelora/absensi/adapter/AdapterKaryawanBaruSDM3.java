...
public class AdapterKaryawanBaruSDM3 extends RecyclerView.Adapter<AdapterKaryawanBaruSDM3.MyViewHolder> {

    private KaryawanSDM[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterKaryawanBaruSDM3(KaryawanSDM[] data, FormSdmActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.parentPart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("f4_karyawan_baru_broad");
