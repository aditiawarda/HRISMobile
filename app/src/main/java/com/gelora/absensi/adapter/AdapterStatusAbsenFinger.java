...
public class AdapterStatusAbsenFinger extends RecyclerView.Adapter<AdapterStatusAbsenFinger.MyViewHolder> {

    private StatusAbsen[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterStatusAbsenFinger(StatusAbsen[] data, FormFingerscanActivity context) {
        this.data = data;
