...
public class AdapterKomponenGaji3 extends RecyclerView.Adapter<AdapterKomponenGaji3.MyViewHolder> {
    ...
    private KomponenGaji3[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterKomponenGaji3(KomponenGaji3[] data, FormSdmActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        final KomponenGaji3 komponenGaji = data[i];
        ...
        if (sharedPrefAbsen.getSpIdKomponenGaji3().equals(komponenGaji.getId())) {
        ...
        myViewHolder.statusParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("f3_komponen_gaji_board");
                intent.putExtra("nama_komponen_gaji",komponenGaji.getKomponen_gaji());
                LocalBroadcastManager.getInstance(mContext).sendBroadcast(intent);

                sharedPrefAbsen.saveSPString(SharedPrefAbsen.SP_ID_KOMPONEN_GAJI_3, komponenGaji.getId());
