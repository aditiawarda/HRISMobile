...
public class AdapterUnitJabatanBaruDetail extends RecyclerView.Adapter<AdapterUnitJabatanBaruDetail.MyViewHolder> {

    private UnitJabatan[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterUnitJabatanBaruDetail(UnitJabatan[] data, FormSdmActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        if (sharedPrefAbsen.getSpIdUnitJabatanBaruDetail().equals(unitJabatan.getIdJabatan())) {
        ...
        myViewHolder.statusParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("f3_jabatan_baru_detail_board");
                intent.putExtra("id_jabatan",unitJabatan.getIdJabatan());
                intent.putExtra("nama_jabatan",unitJabatan.getNmJabatan());
                LocalBroadcastManager.getInstance(mContext).sendBroadcast(intent);

                sharedPrefAbsen.saveSPString(SharedPrefAbsen.SP_ID_UNIT_JABATAN_BARU_DETAIL, unitJabatan.getIdJabatan());
