...
import com.gelora.absensi.EditPermohonanCutiActivity;
import com.gelora.absensi.R;
import com.gelora.absensi.SharedPrefAbsen;
import com.gelora.absensi.model.KategoriIzin;

public class AdapterKategoriIzinEdit extends RecyclerView.Adapter<AdapterKategoriIzinEdit.MyViewHolder> {

    private KategoriIzin[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterKategoriIzinEdit(KategoriIzin[] data, EditPermohonanCutiActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.parentPart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("lampiran_kategori_cuti",kategoriIzin.getLampiran());
