...
public class AdapterInvoicePiutangRealisasi extends RecyclerView.Adapter<AdapterInvoicePiutangRealisasi.MyViewHolder> {

    private DataInvoicePiutang[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterInvoicePiutangRealisasi(DataInvoicePiutang[] data, DetailReportSumaActivity context) {
        this.data = data;
