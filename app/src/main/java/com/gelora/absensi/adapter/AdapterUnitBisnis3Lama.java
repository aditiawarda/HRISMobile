...
public class AdapterUnitBisnis3Lama extends RecyclerView.Adapter<AdapterUnitBisnis3Lama.MyViewHolder> {

    private UnitBisnis[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterUnitBisnis3Lama(UnitBisnis[] data, FormSdmActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.statusParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("f3_unit_bisnis_lama_board");
