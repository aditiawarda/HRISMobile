...
public class AdapterUnitDepartemen2 extends RecyclerView.Adapter<AdapterUnitDepartemen2.MyViewHolder> {

    private UnitDepartemen[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterUnitDepartemen2(UnitDepartemen[] data, FormSdmActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        if (sharedPrefAbsen.getSpIdUnitDepartemen().equals(unitDepartemen.getIdHeadDept())) {
        ...
        myViewHolder.statusParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("f3_departemen_board");
                ...
                sharedPrefAbsen.saveSPString(SharedPrefAbsen.SP_ID_UNIT_DEPARTEMEN, unitDepartemen.getIdHeadDept());
