...
public class AdapterAllKaryawanPICUpdate extends RecyclerView.Adapter<AdapterAllKaryawanPICUpdate.MyViewHolder> {

    private KaryawanAll[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterAllKaryawanPICUpdate(KaryawanAll[] data, UpdateTaskActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.parentPart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("task_pic_broad_update");
