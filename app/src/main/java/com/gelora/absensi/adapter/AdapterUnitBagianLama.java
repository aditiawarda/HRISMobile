...
public class AdapterUnitBagianLama extends RecyclerView.Adapter<AdapterUnitBagianLama.MyViewHolder> {

    private UnitBagian[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterUnitBagianLama(UnitBagian[] data, FormSdmActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        if (sharedPrefAbsen.getSpIdUnitBagianLama().equals(unitBagian.getIdDept())) {
        ...
        myViewHolder.statusParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("f3_bagian_lama_board");
                intent.putExtra("id_bagian",unitBagian.getIdDept());
                intent.putExtra("nama_bagian",unitBagian.getNmDept());
                LocalBroadcastManager.getInstance(mContext).sendBroadcast(intent);

                sharedPrefAbsen.saveSPString(SharedPrefAbsen.SP_ID_UNIT_BAGIAN_LAMA, unitBagian.getIdDept());
