...
public class AdapterKehadiranBagianSearch extends RecyclerView.Adapter<AdapterKehadiranBagianSearch.MyViewHolder> {
    ...
    public AdapterKehadiranBagianSearch(DataMonitoringKehadiranBagian[] data, SearchKaryawanBagianActivity context) {
        this.data = data;
