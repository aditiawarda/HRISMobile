...
public class AdapterUnitBisnis2Lama extends RecyclerView.Adapter<AdapterUnitBisnis2Lama.MyViewHolder> {

    private UnitBisnis[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterUnitBisnis2Lama(UnitBisnis[] data, FormSdmActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        if (sharedPrefAbsen.getSpIdUnitBisnisLama().equals(unitBisnis.getId())) {
        ...
        myViewHolder.statusParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("f2_unit_bisnis_lama_board");
                intent.putExtra("id_unit_lama",unitBisnis.getId());
                intent.putExtra("nama_unit_lama",unitBisnis.getNama_unit());
                LocalBroadcastManager.getInstance(mContext).sendBroadcast(intent);

                sharedPrefAbsen.saveSPString(SharedPrefAbsen.SP_ID_UNIT_BISNIS_LAMA, unitBisnis.getId());
