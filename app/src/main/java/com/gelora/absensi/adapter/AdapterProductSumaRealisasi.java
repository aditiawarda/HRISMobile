...
public class AdapterProductSumaRealisasi extends RecyclerView.Adapter<AdapterProductSumaRealisasi.MyViewHolder> {

    private ProductSuma[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterProductSumaRealisasi(ProductSuma[] data, DetailReportSumaActivity context) {
        this.data = data;
