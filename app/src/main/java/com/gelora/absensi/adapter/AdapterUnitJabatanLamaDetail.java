...
public class AdapterUnitJabatanLamaDetail extends RecyclerView.Adapter<AdapterUnitJabatanLamaDetail.MyViewHolder> {

    private UnitJabatan[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterUnitJabatanLamaDetail(UnitJabatan[] data, FormSdmActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        if (sharedPrefAbsen.getSpIdUnitJabatanLamaDetail().equals(unitJabatan.getIdJabatan())) {
        ...
        myViewHolder.statusParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("f3_jabatan_lama_detail_board");
                intent.putExtra("id_jabatan",unitJabatan.getIdJabatan());
                intent.putExtra("nama_jabatan",unitJabatan.getNmJabatan());
                LocalBroadcastManager.getInstance(mContext).sendBroadcast(intent);

                sharedPrefAbsen.saveSPString(SharedPrefAbsen.SP_ID_UNIT_JABATAN_LAMA_DETAIL, unitJabatan.getIdJabatan());
