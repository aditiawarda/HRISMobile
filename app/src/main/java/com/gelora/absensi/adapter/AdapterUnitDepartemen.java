...
public class AdapterUnitDepartemen extends RecyclerView.Adapter<AdapterUnitDepartemen.MyViewHolder> {

    private UnitDepartemen[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterUnitDepartemen(UnitDepartemen[] data, FormSdmActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.statusParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("f1_departemen_board");
