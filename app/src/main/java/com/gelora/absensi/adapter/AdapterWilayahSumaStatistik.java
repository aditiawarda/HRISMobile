...
import com.gelora.absensi.SaleStatisticActivity;
import com.gelora.absensi.SharedPrefAbsen;
import com.gelora.absensi.model.WilayahSuma;

public class AdapterWilayahSumaStatistik extends RecyclerView.Adapter<AdapterWilayahSumaStatistik.MyViewHolder> {

    private WilayahSuma[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterWilayahSumaStatistik(WilayahSuma[] data, SaleStatisticActivity context) {
        this.data = data;
