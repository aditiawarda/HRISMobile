...
public class AdapterKaryawanPenggantiEdit extends RecyclerView.Adapter<AdapterKaryawanPenggantiEdit.MyViewHolder> {

    private KaryawanPengganti[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterKaryawanPenggantiEdit(KaryawanPengganti[] data, EditPermohonanCutiActivity context) {
        this.data = data;
