...
public class AdapterPermohonanIzin extends RecyclerView.Adapter<AdapterPermohonanIzin.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        } else if(sharedPrefManager.getSpIdJabatan().equals("11")||sharedPrefManager.getSpIdJabatan().equals("25")||sharedPrefManager.getSpIdJabatan().equals("35")|| (sharedPrefManager.getSpIdJabatan().equals("14")&&(sharedPrefManager.getSpNik().equals("1280270910")||sharedPrefManager.getSpNik().equals("1090080310")||sharedPrefManager.getSpNik().equals("2840071116")))) { // Kabag Supervisor
        ...
        if(listPermohonanIzin.getTipe_pengajuan().equals("1")){
            if(sharedPrefManager.getSpIdJabatan().equals("11")||sharedPrefManager.getSpIdJabatan().equals("25")||sharedPrefManager.getSpIdJabatan().equals("35")|| (sharedPrefManager.getSpIdJabatan().equals("14")&&(sharedPrefManager.getSpNik().equals("1280270910")||sharedPrefManager.getSpNik().equals("1090080310")||sharedPrefManager.getSpNik().equals("2840071116")))){
                // if(sharedPrefManager.getSpNik().equals("0056010793")){ // Bu Sorta
