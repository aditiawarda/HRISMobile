...
public class AdapterKaryawanLamaSDM2 extends RecyclerView.Adapter<AdapterKaryawanLamaSDM2.MyViewHolder> {

    private KaryawanSDM[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterKaryawanLamaSDM2(KaryawanSDM[] data, FormSdmActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.parentPart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("f3_karyawan_lama_broad");
                ...
                intent.putExtra("status_karyawan_lama",karyawanSDM.getStatus_karyawan());
                intent.putExtra("golongan_karyawan_lama",karyawanSDM.getGolongan_karyawan());
