...
public class AdapterUnitBisnis4 extends RecyclerView.Adapter<AdapterUnitBisnis4.MyViewHolder> {

    private UnitBisnis[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterUnitBisnis4(UnitBisnis[] data, FormSdmActivity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.statusParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent("f4_unit_bisnis_board");
