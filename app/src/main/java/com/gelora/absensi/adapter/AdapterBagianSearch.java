...
public class AdapterBagianSearch extends RecyclerView.Adapter<AdapterBagianSearch.MyViewHolder> {

    private Bagian[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterBagianSearch(Bagian[] data, SearchKaryawanBagianActivity context) {
        this.data = data;
