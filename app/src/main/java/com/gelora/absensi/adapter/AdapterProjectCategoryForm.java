...
public class AdapterProjectCategoryForm extends RecyclerView.Adapter<AdapterProjectCategoryForm.MyViewHolder> {

    private ProjectCategory[] data;
    private Context mContext;
    SharedPrefAbsen sharedPrefAbsen;

    public AdapterProjectCategoryForm(ProjectCategory[] data, FormInputProjectActivity context) {
        this.data = data;
