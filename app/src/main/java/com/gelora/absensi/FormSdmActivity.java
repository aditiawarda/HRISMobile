...
public class FormSdmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        f3GolonganLamaPart = findViewById(R.id.f3_golongan_lama_part);
        f3GolonganDisableModeLamaTV = findViewById(R.id.f3_golongan_disable_mode_tv_lama);
        f3GolonganDisableModeTV = findViewById(R.id.f3_golongan_disable_mode_tv);
        f3GolonganPart = findViewById(R.id.f3_golongan_part);
        ...
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                f3GolonganDisableModeLamaTV.setText("");
                f3GolonganDisableModeTV.setText("");
                ...
                if(kodeKeterangan.equals("1")) { //Form 1
                    ...
                    if(kodeKeterangan.equals("5")){
                        if (f3SubKet.equals("") || f3NikBaru.equals("") || f3DepartemenBaru.equals("") || f3BagianBaru.equals("") || f3JabatanBaru.equals("") || f3IdUnitBisnis.equals("") || f3KomponenGajiPilihTV.getText().toString().equals("") || f3NikLama.equals("") || f3IdUnitBisnisLama.equals("") || f3DepartemenLama.equals("") || f3BagianLama.equals("") || f3JabatanLama.equals("") || f3KomponenGajiDisableModeLamaTV.getText().toString().equals("") || f3JabatanLamaDetail.equals("") || f3TglPengangkatanJabatanLama.equals("") || f3JabatanBaruDetail.equals("") || f3TglPengangkatanJabatanBaru.equals("") || f3AlasanPengangkatanTV.getText().toString().equals("") || f3TglDibutuhkan.equals("") || f3TglPemenuhan.equals("")) {
                            ...
                            if(f3SubKet.equals("1") && penilaianUriFile==null){
                                new KAlertDialog(FormSdmActivity.this, KAlertDialog.ERROR_TYPE)
                                        .setTitleText("Perhatian")
                                        .setContentText("Pastikan penilaian tahunan terisi!")
                                        .setConfirmText("    OK    ")
                                        .setConfirmClickListener(new KAlertDialog.KAlertClickListener() {
                                            @Override
                                            public void onClick(KAlertDialog sDialog) {
        ...
        ket1BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(sharedPrefManager.getSpIdJabatan().equals("1") || sharedPrefManager.getSpIdJabatan().equals("85") || sharedPrefManager.getSpIdJabatan().equals("11") || sharedPrefManager.getSpIdJabatan().equals("25") || sharedPrefManager.getSpNik().equals("3313210223") || sharedPrefManager.getSpNik().equals("3196310521") || sharedPrefManager.getSpNik().equals("3310140223") || sharedPrefManager.getSpNik().equals("1311201210")){
                    ...
                    getBagianDepartemen();
                } else if(sharedPrefManager.getSpIdJabatan().equals("41") || sharedPrefManager.getSpIdJabatan().equals("10") || sharedPrefManager.getSpIdJabatan().equals("90") || sharedPrefManager.getSpIdJabatan().equals("3")){
                    f1UnitBisnisPart.setVisibility(View.GONE);
                    f1UnitBisnisDisableMode.setVisibility(View.VISIBLE);
                    f1DepartemenPart.setVisibility(View.GONE);
                    f1DepartemenDisableMode.setVisibility(View.VISIBLE);
    ...
    private void dateDibutuhkan(){
        ...
        if(!f1TglDibutuhkan.equals("")){
            y = Integer.parseInt(f1TglDibutuhkan.substring(0,4));
            m = Integer.parseInt(f1TglDibutuhkan.substring(5,7));
            d = Integer.parseInt(f1TglDibutuhkan.substring(8,10));
        } else {
    ...
    private void datePemenuhan(){
        int y, m, d;
        if(!f1TglPemenuhan.equals("")){
            y = Integer.parseInt(f1TglPemenuhan.substring(0,4));
            m = Integer.parseInt(f1TglPemenuhan.substring(5,7));
            d = Integer.parseInt(f1TglPemenuhan.substring(8,10));
        } else {
            y = Integer.parseInt(getDateY());
            m = Integer.parseInt(getDateM());
            d = Integer.parseInt(getDateD());
    ...
    private void dateDibutuhkan2(){
        ...
        if(!f3TglDibutuhkan.equals("")){
            y = Integer.parseInt(f3TglDibutuhkan.substring(0,4));
            m = Integer.parseInt(f3TglDibutuhkan.substring(5,7));
            d = Integer.parseInt(f3TglDibutuhkan.substring(8,10));
        } else {
            y = Integer.parseInt(getDateY());
            m = Integer.parseInt(getDateM());
            d = Integer.parseInt(getDateD());
    ...
    private void datePemenuhan2(){
        int y, m, d;
        if(!f3TglPemenuhan.equals("")){
            y = Integer.parseInt(f3TglPemenuhan.substring(0,4));
            m = Integer.parseInt(f3TglPemenuhan.substring(5,7));
            d = Integer.parseInt(f3TglPemenuhan.substring(8,10));
        } else {
            y = Integer.parseInt(getDateY());
            m = Integer.parseInt(getDateM());
            d = Integer.parseInt(getDateD());
    ...
    public BroadcastReceiver f3KaryawanLamaBroad = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            String id_jabatan_karyawan_lama = intent.getStringExtra("id_jabatan_karyawan_lama");
            String status_karyawan_lama = intent.getStringExtra("status_karyawan_lama");
            String golongan_karyawan_lama = intent.getStringExtra("golongan_karyawan_lama");
            ...
            f3GolonganDisableModeLamaTV.setText(golongan_karyawan_lama);
            ...
            try {
                if(golongan_karyawan_lama.equals("1")){
                    f3GolonganDisableModeTV.setText("2");
                } else if(golongan_karyawan_lama.equals("2")){
                    f3GolonganDisableModeTV.setText("3");
                } else if(golongan_karyawan_lama.equals("3")){
                    f3GolonganDisableModeTV.setText("4");
                } else if(golongan_karyawan_lama.equals("4")){
                    f3GolonganDisableModeTV.setText("5");
                } else if(golongan_karyawan_lama.equals("5")){
                    f3GolonganDisableModeTV.setText("6");
                } else if(golongan_karyawan_lama.equals("6")){
                    f3GolonganDisableModeTV.setText("7");
                } else if(golongan_karyawan_lama.equals("7")){
                    f3GolonganDisableModeTV.setText("8");
                } else if(golongan_karyawan_lama.equals("8")){
                    f3GolonganDisableModeTV.setText("9");
                } else if(golongan_karyawan_lama.equals("9")){
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("Success")){
                                String id = data.getString("id_data");
                                if(kodeKeterangan.equals("5") && f3SubKet.equals("1")){
                                    uploadPenilaian(id);
                                } else {
                                    perngajuanTerkirim = "1";
                                    pDialog.dismiss();
    ...
    private void dateMulai(){
        ...
        if(!f2DateChoiceMulai.equals("")){
            y = Integer.parseInt(f2DateChoiceMulai.substring(0,4));
            m = Integer.parseInt(f2DateChoiceMulai.substring(5,7));
            d = Integer.parseInt(f2DateChoiceMulai.substring(8,10));
        } else {
            y = Integer.parseInt(getDateY());
            m = Integer.parseInt(getDateM());
            d = Integer.parseInt(getDateD());
    ...
    private void dateAkhir(){
        int y, m, d;
        if(!f2DateChoiceAkhir.equals("")){
            y = Integer.parseInt(f2DateChoiceAkhir.substring(0,4));
            m = Integer.parseInt(f2DateChoiceAkhir.substring(5,7));
            d = Integer.parseInt(f2DateChoiceAkhir.substring(8,10));
        } else {
            y = Integer.parseInt(getDateY());
            m = Integer.parseInt(getDateM());
            d = Integer.parseInt(getDateD());
