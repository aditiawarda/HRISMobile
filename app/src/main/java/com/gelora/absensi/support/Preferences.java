...
public class Preferences {
    ...
    static final String KEY_USER_TEREGISTER ="email", KEY_PASS_TEREGISTER ="password";
    static final String KEY_USER_SEDANG_LOGIN = "Username_logged_in";
    ...
    public static void setLoggedInUser(Context context, String email){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString(KEY_USER_SEDANG_LOGIN, email);
        editor.apply();
    }
    /** Mengembalikan nilai dari key KEY_USERNAME_SEDANG_LOGIN berupa String */
    public static String getLoggedInUser(Context context){
        return getSharedPreference(context).getString(KEY_USER_SEDANG_LOGIN,"");
    }
