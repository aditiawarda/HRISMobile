...
public class SharedPrefAbsen {
    ...
    public String getSpIdKomponenGaji3(){
        return sp.getString(SP_ID_KOMPONEN_GAJI_3, "");
    }
    ...
    public String getSpStatusTask(){
        return sp.getString(SP_STATUS_TASK, "");
    }
    ...
    public String getSpNoSj(){
        return sp.getString(SP_NO_SJ, "");
    }

    public String getSpSalesActive(){
        return sp.getString(SP_SALES_ACTIVE, "");
    }
    ...
    public String getSpReloadRequest(){
        return sp.getString(SP_RELOAD_REQUEST, "");
    }
